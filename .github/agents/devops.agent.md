---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-financial, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-financial`.
...
- Checkout local: `app-community/modules/controleonline/ui-financial`
